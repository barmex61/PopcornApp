...
class FragmentFactories @Inject constructor(private val tvShowAdapter:TvShowAdapter,private val seasonAdapter: SeasonAdapter,private val searchAdapter: SearchAdapter,private val movieAdapter: MovieAdapter,private val watchListAdapter: WatchListAdapter) : FragmentFactory() {
