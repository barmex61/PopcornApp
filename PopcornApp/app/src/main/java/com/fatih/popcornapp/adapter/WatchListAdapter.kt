...
import com.fatih.popcornapp.databinding.WatchListLayoutRowBinding
import com.fatih.popcornapp.model.RoomEntity
import com.fatih.popcornapp.view.WatchListFragmentDirections


class WatchListAdapter(private val watch:ArrayList<RoomEntity>): RecyclerView.Adapter<WatchListAdapter.WatchListViewHolder>() {
    ...
    private fun getDominantColor(holder: WatchListAdapter.WatchListViewHolder, view: View, position: Int){
        if(holder.binding.movieImage2.drawable!=null){
            ...
            Palette.Builder(bitmap).generate {
                ...
                val action= WatchListFragmentDirections.actionWatchListFragmentToDetailsFragment(watch[position].id,vibrantColor,watch[position].isTvShow)
